(function( $ , api){
    ...
    api.section( 'medico_fof_section' , function( section ){
    ...
    // Customizer about page redirect
    api.section( 'medico_about_section' , function( section ){
    ...
    api.section( 'medico_blog_section' , function( section ){
    ...
    api.section( 'medico_contact_section' , function( section ){

        section.expanded.bind( function( isExpanded ){

            // Customizer contact form seclector 
            var customshortcodefield = $('#customize-control-medico_contact_custom_formshortcode'),
                selector = $('#_customize-input-medico_contact_formshortcode');
    ...
    // General section
    api.section( 'medico_general_section' , function( section ){
        ...
        section.expanded.bind( function( isExpanded ){
            ...
            var $preloader      = $('#medico_preloader_toggle'),
                $preloaderbg    = $( '#customize-control-medico_preloader_bg_color' ),
                $preloadercolor = $( '#customize-control-medico_preloader_color' );
            ...
            var $backtotop          = $( '#medico_backtotop_btn' ),
                $backtotopbg        = $( '#customize-control-medico_backtotop_btn_bg_color' ),
                $backtotophoverbg   = $( '#customize-control-medico_backtotop_btn_hover_bg_color' );
    ...
    // Footer section
    api.section( 'medico_footer_section' , function( section ){
        ...
        section.expanded.bind( function( isExpanded ){
            ...
            var $widget_toggle      = $('#medico_footer_widget_toggle');
