...
// image default alt
if( !function_exists( 'medico_img_default_alt' ) ){
	function medico_img_default_alt( $url = '' ){
...
// Image Tag
if( !function_exists( 'medico_img_tag' ) ){
	function medico_img_tag( array $args ){
		...
		if( !empty( $args['alt'] ) ){
			...
			$alt = medico_img_default_alt( $url );
		}
...
// Anchor Tag
if( !function_exists( 'medico_anchor_tag' ) ){
	function medico_anchor_tag( array $args ){
...
// Heading Tag
if( !function_exists( 'medico_heading_tag' ) ){
	function medico_heading_tag( array $args ){
...
// Paragraph Tag
if( !function_exists( 'medico_paragraph_tag' ) ){
	function medico_paragraph_tag( array $args ){
...
// Other Tag
if( !function_exists( 'medico_other_tag' ) ){
	function medico_other_tag( array $args ){
...
// Button Element 
if( !function_exists( 'medico_button_element ' ) ){
	function medico_button_element( array $args ){
