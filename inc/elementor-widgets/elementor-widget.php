    ...
    final class Medico_El_Widgets {
        ...
        public function enqueue_element_widgets_scripts() {
            ...
            ******************/
            ...
            wp_register_script( 'medico-map-custom', MEDICO_DIR_ELEMENTOR . 'assets/js/map-custom.js', array(), '1.0-s2', true );

            // medico companion main js
            wp_enqueue_script( 'medico', MEDICO_DIR_ELEMENTOR . 'assets/js/medico-companion-main.js', array( 'medico-ui-js' ), '1.0-s2', true );
