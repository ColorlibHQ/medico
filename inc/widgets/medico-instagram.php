...
----------------------------------------*/
class medico_instagram_photo extends WP_Widget {
	public function __construct(){
		parent::__construct('medico_instagram_photo',esc_html__('[ Medico ] Intagram Photo','medico'),array(
			'description' => esc_html__('Medico Instagram Photo Widget','medico'),
		));
	}
	...
	public function form($instance){
		$title      = isset( $instance['title'] ) ? $instance['title'] : esc_html__('Instagram', 'medico');
        ...
        <p>
            <label for="<?php echo esc_attr( $this->get_field_id( 'insta_user' ) ); ?>"><?php esc_html_e( 'User Name:' ,'medico'); ?></label>
        ...
        <p>
            <label for="<?php echo esc_attr( $this->get_field_id( 'insta_items' ) ); ?>"><?php esc_html_e( 'Item Number:' ,'medico'); ?></label>
...
if(!function_exists('medico_instagram_widgets')):
	function medico_instagram_widgets(){
		register_widget('medico_instagram_photo');
	}
	add_action('widgets_init','medico_instagram_widgets');
endif;
